...
public class OAuthRegistry {
	...
	protected static final String OAUTH_RESOURCE = "google_oauth.json";
	 ...
	 * 
	 * @param service
	 *            name for which we create the authorization flow.
	 * @return an authorization flow configured for the service provided as
	 *         parameter
	 * @throws IOException
	 *             when there is no configuration for the service in the registry
	 */
